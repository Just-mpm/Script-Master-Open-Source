...
## 📖 Guia de Referência de Geração

> Antes de gerar **imagens** ou **áudio (TTS)**, consulte o arquivo [`guia-geracao.md`](./guia-geracao.md) neste mesmo diretório.
>
> Ele contém:
> - **Vozes:** quais vozes em português foram aprovadas/reprovadas e por quê
> - **Imagens:** regras de ouro para incluir texto em imagens (o que funciona e o que não funciona)
> - **Estilos:** qual estilo visual teve melhor resultado (Pixar/3D)
