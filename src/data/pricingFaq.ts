...
'pt-BR': {
    ...
    faq0Answer:
      'Cada geração de áudio, imagem ou interação com o assistente usa créditos do seu saldo. Você recebe 500 créditos grátis todo início de mês. Saldo exibido no header.',
    ...
    faq3Answer:
      '100% gratuito. 500 créditos por mês, sem cartão de crédito. Nenhuma cobrança durante o beta.',
  ...
  en: {
    ...
    faq0Answer:
      'Each audio, image, or assistant interaction uses credits from your balance. You get 500 free credits at the start of each month. Balance shown in the header.',
    ...
    faq3Answer:
      '100% free. 500 credits per month, no credit card. No charges during beta.',
    ...
    faq5Answer:
      'No. Balance resets to 500 at the start of each month. Unused credits expire.',
  },
  es: {
    faq0Question: '¿Cómo funcionan los créditos?',
    faq0Answer:
      'Cada generación de audio, imagen o interacción con el asistente usa créditos de tu saldo. Recibes 500 créditos gratis al inicio de cada mes. Saldo mostrado en el header.',
    ...
    faq3Answer:
      '100% gratuito. 500 créditos por mes, sin tarjeta de crédito. Sin cobros durante el beta.',
    ...
    faq5Answer:
      'No. El saldo se renueva a 500 al inicio de cada mes. Los créditos no utilizados caducan.',
  },
} as const;
