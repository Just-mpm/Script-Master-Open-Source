...
const metricsStrings = {
  'pt-BR': {
    ...
    metric0Desc: 'Roteiros transformados em conteúdo desde o lançamento',
    metric1Label: 'Minutos de áudio',
    metric1Desc: 'De narração profissional gerada com IA',
    metric2Label: 'Criadores ativos',
    metric2Desc: 'Usuários criando conteúdo com o Script Master',
    metric3Label: 'Satisfação',
    metric3Desc: 'Avaliação média dos criadores que usam a plataforma',
  },
  en: {
    metric0Label: 'Scripts processed',
    metric0Desc: 'Scripts turned into content since launch',
    metric1Label: 'Minutes of audio',
    metric1Desc: 'Of professional narration generated with AI',
    metric2Label: 'Active creators',
    metric2Desc: 'Users creating content with Script Master',
    metric3Label: 'Satisfaction',
    metric3Desc: 'Average rating from creators using the platform',
  },
  es: {
    metric0Label: 'Guiones procesados',
    metric0Desc: 'Guiones transformados en contenido desde el lanzamiento',
    metric1Label: 'Minutos de audio',
    metric1Desc: 'De narración profesional generada con IA',
    metric2Label: 'Creadores activos',
    metric2Desc: 'Usuarios creando contenido con Script Master',
    metric3Label: 'Satisfacción',
    metric3Desc: 'Calificación promedio de los creadores que usan la plataforma',
  },
} as const;
