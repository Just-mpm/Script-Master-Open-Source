...
export const es: TranslationDictionary = {
  ...
  video: {
    ...
    // v0.133.1: panel de modo de renderizado (Clásico/Dibujo) por escena
    sceneRenderMode: {
      eyebrow: 'Speed paint',
      title: 'Modo por escena',
      subtitle: 'Define Clásico o Dibujo individualmente para cada escena.',
      modeMask: 'Clásico',
      modeVetorial: 'Dibujo',
      modeInherit: 'Global',
      legendMask: 'Clásico = revelado por máscara',
      legendVetorial: 'Dibujo = animación vectorial con paths SVG',
      legendInherit: 'Sin elección = usa modo global del panel de exportación',
      cycleModeAria: 'Escena {index}: {current} (clic para cambiar)',
    },
    summaryPanel: {
  ...
  speedPaint: {
    ...
    // v0.133.1: badge + toggle del modo de renderizado (Clásico/Dibujo) por item
    queueModeBadgeVetorial: 'Modo Dibujo (clic para cambiar)',
    queueModeBadgeMask: 'Modo Clásico (clic para cambiar)',
    queueToggleModeAria: 'Cambiar modo de renderizado de {filename}',
