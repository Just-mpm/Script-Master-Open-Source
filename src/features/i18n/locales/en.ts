...
export const en: TranslationDictionary = {
  ...
  video: {
    ...
    // v0.133.1: render mode panel (Classic/Draw) per scene
    sceneRenderMode: {
      eyebrow: 'Speed paint',
      title: 'Mode per scene',
      subtitle: 'Choose Classic or Draw individually for each scene.',
      modeMask: 'Classic',
      modeVetorial: 'Draw',
      modeInherit: 'Global',
      legendMask: 'Classic = mask reveal',
      legendVetorial: 'Draw = vector animation with SVG paths',
      legendInherit: 'No choice = uses global mode from the export panel',
      cycleModeAria: 'Scene {index}: {current} (click to switch)',
    },
    summaryPanel: {
  ...
  speedPaint: {
    ...
    // v0.133.1: badge + toggle of render mode (Classic/Draw) per queue item
    queueModeBadgeVetorial: 'Draw mode (click to switch)',
    queueModeBadgeMask: 'Classic mode (click to switch)',
    queueToggleModeAria: 'Toggle render mode of {filename}',
