  ...
  'en': {
    ...
    sections: [
      ...
      },
      {
        ...
        content: 'The Company will not be liable for any indirect, incidental, special, or consequential damages arising from the use or inability to use the Service. The total liability of the Company shall not exceed the amount paid by you in the last 12 months. The Service is provided without warranties of any kind, express or implied.',
      },
      {
        id: 'propriedade',
        title: '7. Intellectual Property',
        content: 'All content on the Service, including but not limited to software, design, logos, icons, texts, and graphics, is the property of the Company or its licensors and is protected by intellectual property laws. Content generated by AI through the Service is owned by the User, subject to beta limits.',
      },
      {
        id: 'modificacoes',
  ...
  'es': {
    ...
    sections: [
      ...
      },
      {
        ...
        content: 'La Empresa no será responsable de ningún daño indirecto, incidental, especial o consecuente que surja del uso o la imposibilidad de usar el Servicio. La responsabilidad total de la Empresa no excederá el monto pagado por usted en los últimos 12 meses. El Servicio se proporciona sin garantías de ningún tipo, expresas o implícitas.',
      },
      {
        id: 'propriedade',
        title: '7. Propiedad Intelectual',
        content: 'Todo el contenido del Servicio, incluyendo pero no limitado a software, diseño, logotipos, iconos, textos y gráficos, es propiedad de la Empresa o de sus licenciantes y está protegido por las leyes de propiedad intelectual. El contenido generado por IA a través del Servicio es propiedad del Usuario, sujeto a los límites de la versión beta.',
      },
      {
        id: 'modificacoes',
