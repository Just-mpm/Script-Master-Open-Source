...
The transcript is the exact words the model will speak. You can change how
words, sentences or sections of your transcript are delivered by using audio tags.

An audio tag is a word in square brackets that indicates either how something
should be said, a change of tone, or an interjection.
...
Here are some commonly used tags to get started with:
...
Here is a non-exhaustive list of inline audio tags that can be used to guide audio style:
...
The following constraints apply specifically when utilizing the Gemini 3.1 Flash TTS Preview
